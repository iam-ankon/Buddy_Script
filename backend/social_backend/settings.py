...
INSTALLED_APPS = [
    ...
    'cloudinary_storage',  # must come AFTER staticfiles to avoid intercepting static file handling
    'cloudinary',           
    'rest_framework',
    'corsheaders',
    'api',
...
# WhiteNoise serves and compresses static files (including Django admin CSS) on Render
